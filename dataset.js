const dataset = [ //constante que constrói o array inserindo nome e a descrição dos produtos junto com as imagens abaixo
  {
    id: 1,
    name: 'Hambúrguer',
...
export default dataset; //exporta os itens do array
